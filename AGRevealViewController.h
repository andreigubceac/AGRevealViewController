...
@property (readonly) BOOL isLeftSideDisplayed, isRightSideDisplayed, isCenterSideDisplayed;
...
- (void)panGestureAction:(nonnull UIScreenEdgePanGestureRecognizer*)g;//subclass
@end
